...
export function useLocalStorage<T>(
  ...
  //biome-ignore lint/correctness/useExhaustiveDependencies: Only want to re-run this effect when the key changes, and avoid unnecessary re-initialization and preserve expected localStorage behavior.
  useEffect(() => {
